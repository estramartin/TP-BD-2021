...
begin 
	...
	iniciales_nombre = substring(nombre, 1,1);
	inciales_apellido = substring(apellido,1,1);
	concat_iniciales = upper(iniciales_nombre) || upper(inciales_apellido);
...
select GenerarIniciales(p.nombre, p.apellido ) from personas p


create or replace function GenerarIniciales(nombre varchar(15),nombre2 varchar(15), apellido varchar(15)) returns varchar(4) as $$
declare 
iniciales_nombre varchar(1);
...
begin 
	...
	iniciales_nombre = substring(nombre, 1,1);
	iniciales_nombre2 = substring(nombre2, 1,1);
	inciales_apellido = substring(apellido,1,1);
	
	concat_iniciales = upper (iniciales_nombre) || upper( iniciales_nombre2) || upper( inciales_apellido) ;
...
create or replace function GenerarIniciales(nombre varchar(15),nombre2 varchar(15), apellido varchar(15),apellido2 varchar(15)) returns varchar(4) as $$
declare 
iniciales_nombre varchar(1);
iniciales_nombre2 varchar(1);
inciales_apellido varchar(1);
...
begin 
	...
	iniciales_nombre2 = substring(nombre2, 1,1);
	inciales_apellido = substring(apellido,1,1);
	inciales_apellido2 = substring(apellido,1,1);
	
	concat_iniciales = upper (iniciales_nombre) || upper( iniciales_nombre2) || upper( inciales_apellido)|| upper( inciales_apellido2) ;
